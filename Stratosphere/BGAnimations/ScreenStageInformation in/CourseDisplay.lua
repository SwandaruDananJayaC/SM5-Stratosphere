...
local t = Def.ActorFrame{
	...
	Def.Sprite{
		...
		OnCommand=cmd(scaletoclipped,480,480;Center;diffusealpha,0;zoom,4;sleep,0.9;linear,0.2;diffusealpha,1;zoom,1;sleep,3;diffusealpha,1);
	};
		...
		OnCommand=cmd(diffusealpha,0;zoom,4;sleep,0.95;linear,0.2;diffusealpha,1;zoom,1;decelerate,0.7;diffusealpha,0;zoom,1.15);
	};
