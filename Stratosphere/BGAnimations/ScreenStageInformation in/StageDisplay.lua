...
--- STAGE FRAME APPARITION > DISPARITION ---
	...
	InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y);
		OnCommand=cmd(diffusealpha,0;sleep,1.2;addx,-600;diffusealpha,1;linear,0.2;addx,600;sleep,0.01;zoom,1.3;linear,0.1;zoom,1;);
	};
	...
	InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y;blend,'BlendMode_Add';zoom,1.3);
		OnCommand=cmd(diffusealpha,0;sleep,1.2;linear,0.25;diffusealpha,1;sleep,0.01;zoom,1.3;linear,0.13;zoom,1;linear,0.1;diffusealpha,0;sleep,3);
	};
	--[[
	LoadActor( THEME:GetPathG("ScreenStageInformation", "Stage " .. ToEnumShortString(sStage) ) ) .. {
	InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y);
